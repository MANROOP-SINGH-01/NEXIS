...
const InspectorPanel: React.FC<InspectorPanelProps> = ({ isFloating }) => {
  ...
  return (
    <div className={`${isFloating ? 'w-full h-full max-h-[85vh] self-end rounded-lg shadow-2xl border border-white/20' : 'w-[360px] h-full border-l border-zinc-100'} bg-white flex flex-col pointer-events-auto shrink-0 relative z-30 overflow-hidden transition-all duration-300`}>
      {!agent ? (
          ...
          <div className={`px-4 py-3 border-b border-zinc-100 bg-white ${isFloating ? 'bg-zinc-50/50' : ''}`}>
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-4">
                <div className="shrink-0 rounded-lg p-0.5 bg-zinc-50 border border-zinc-100/50">
                  <Avatar
