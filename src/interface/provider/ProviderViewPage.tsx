  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-zinc-50 flex flex-col items-center justify-center p-6 text-zinc-500 font-sans">
        <div className="w-12 h-12 rounded-lg bg-white border border-zinc-200 flex items-center justify-center shadow-xs mb-3">
  ...
  if (errorStatus || !data) {
    return (
      <div className="min-h-screen bg-zinc-50 flex flex-col items-center justify-center p-6 text-zinc-900 font-sans">
        <div className="bg-white rounded-lg border border-zinc-200 p-8 max-w-md w-full text-center shadow-sm">
          ...
          <a
            href="/"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-zinc-900 hover:bg-black text-white rounded-md text-xs font-bold transition-all shadow-xs"
          >
            Return to Homepage
          </a>
        </div>
    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900 font-sans flex flex-col">
      ...
      <header className="h-16 bg-white border-b border-zinc-200/80 px-6 flex items-center justify-between sticky top-0 z-30 shadow-xs">
        ...
        <div className="flex items-center gap-2 text-xs">
          ...
          <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-md text-[11px] font-bold">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto p-6 md:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-lg border border-blue-200 p-5 shadow-xs flex flex-col justify-between relative overflow-hidden bg-gradient-to-br from-white to-blue-50/40 sm:col-span-2">
        ...
        <div className="bg-white rounded-lg border border-zinc-200/80 p-5 shadow-xs space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-2 pb-3 border-b border-zinc-100">
            ...
            {averageRelevanceScore !== null && (
              <span className="px-3 py-1 bg-blue-50 text-blue-800 border border-blue-200 rounded-md text-xs font-black">
          ...
          {courses.length === 0 ? (
            ...
            <div className="space-y-4">
              {courses.map((course) => (
                <div key={course.id} className="p-4 bg-zinc-50/70 border border-zinc-200 rounded-lg space-y-4">
                  {/* Course Header */}
                  <div className="flex flex-wrap items-center justify-between gap-2 border-b border-zinc-200 pb-3">
                    ...
                    {course.relevanceScore !== null ? (
                      <span
                        className={`px-3 py-1 rounded-md text-xs font-black border ${
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                    {/* Employer Reasons */}
                    <div className="p-3 rounded-md bg-red-50/60 border border-red-200 text-red-950">
                    ...
                    {/* Trainee Reasons */}
                    <div className="p-3 rounded-md bg-amber-50/60 border border-amber-200 text-amber-950">
