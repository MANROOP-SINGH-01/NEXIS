...
export const AuditModal: React.FC<AuditModalProps> = ({ taskId, isOpen, onClose, viewOnly }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-6 md:p-12">
      ...
      {/* Modal Container */}
      <div className="relative bg-white w-full max-w-4xl max-h-full rounded-lg shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-zinc-200/50 flex flex-col overflow-hidden animate-in zoom-in-95 fade-in duration-500 ease-out fill-mode-both">
        ...
        <div className="px-8 py-8 flex items-center justify-between bg-white shrink-0">
          ...
          <button
            onClick={onClose}
            className="p-3 hover:bg-zinc-100 rounded-lg transition-all group"
          >
          ...
          <div className="flex gap-6">
            ...
            <div className={`flex-1 space-y-10 ${task.revisions.length > 0 ? 'border-r border-zinc-100 pr-6' : ''}`}>
              ...
              <section className="space-y-4">
                ...
                <div className="p-8 bg-zinc-50/50 rounded-lg border border-zinc-100 min-h-[350px] shadow-inner">
        ...
        <div className="px-8 py-8 bg-zinc-50/50 border-t border-zinc-100 flex items-center justify-end gap-4 shrink-0">
          {(isViewMode || selectedRevisionIndex !== null) ? (
            <button
              ...
              className="h-12 px-10 bg-darkDelegation text-white rounded-lg text-[10px] font-black uppercase tracking-widest transition-all hover:bg-black active:scale-95 flex items-center gap-2 shadow-xl shadow-darkDelegation/10"
            >
            ...
            <>
              <button
                ...
                className={`
                  h-12 px-8 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2
                  ${!feedback.trim()
