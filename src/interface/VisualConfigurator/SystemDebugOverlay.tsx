...
export const SystemDebugOverlay: React.FC<SystemDebugOverlayProps> = ({ system, onClose }) => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed inset-4 bg-white border border-zinc-200 shadow-2xl rounded-lg z-[1000] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
