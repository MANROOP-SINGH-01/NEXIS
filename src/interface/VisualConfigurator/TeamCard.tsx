...
export const TeamCard: React.FC<TeamCardProps> = ({
  ...
  return (
    <div
      ...
      className={`group relative p-3.5 rounded-lg transition-all cursor-pointer border-[3px] ${isSelected ? 'bg-zinc-50/50 shadow-sm' : 'bg-white hover:border-zinc-200/50'
        }`}
      style={{
