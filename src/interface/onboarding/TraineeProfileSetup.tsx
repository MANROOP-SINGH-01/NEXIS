...
export const TraineeProfileSetup: React.FC<TraineeProfileSetupProps> = ({ onProfileSaved }) => {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 md:p-6 pointer-events-auto overflow-hidden">
      ...
      <div className="absolute inset-0 bg-slate-900/60 animate-in fade-in duration-500" />

      {/* Modal Card */}
      <div className="relative w-full max-w-2xl bg-white rounded-lg shadow-[0_32px_64px_-12px_rgba(0,0,0,0.12)] p-6 md:p-8 border border-zinc-100 animate-in fade-in slide-in-from-bottom-4 duration-500 max-h-[92vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="flex items-start justify-between gap-4 mb-5 shrink-0">
          ...
          <div
            className="w-12 h-12 rounded-lg flex items-center justify-center shrink-0 hidden sm:flex"
        ...
        {/* Error Alert */}
        {error && (
          <div className="mb-4 p-3.5 bg-red-50 text-red-700 text-xs rounded-md border border-red-100 font-medium flex items-center gap-2 shrink-0">
        ...
        <form onSubmit={handleSendOtp} className="flex-1 flex flex-col min-h-0">
          <div className="flex-1 overflow-y-auto pr-1 space-y-4">
            ...
            <div className="p-4 rounded-lg bg-zinc-50/70 border border-zinc-200/70 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white border border-zinc-200 rounded-md px-3 py-2 text-xs text-zinc-800 focus:outline-none focus:ring-2 focus:ring-darkDelegation/20"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white border border-zinc-200 rounded-md px-3 py-2 text-xs text-zinc-800 focus:outline-none focus:ring-2 focus:ring-darkDelegation/20 font-mono"
                  />
                </div>
                ...
                <div>
                  <label className="block text-[11px] font-bold text-zinc-700 mb-1">
                    Portfolio / Website <span className="font-normal text-zinc-400">(Optional)</span>
                  </label>
                  <input
                    type="text"
                    name="identityLast4"
                    ...
                    className="w-full bg-white border border-zinc-200 rounded-md px-3 py-2 text-xs text-zinc-800 focus:outline-none focus:ring-2 focus:ring-darkDelegation/20 font-mono tracking-widest"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full bg-white border border-zinc-200 rounded-md px-3 py-2 text-xs text-zinc-800 focus:outline-none focus:ring-2 focus:ring-darkDelegation/20 cursor-pointer"
                  >
          ...
          <form onSubmit={handleVerifyOtp} className="flex-1 flex flex-col min-h-0 justify-center items-center py-8">
            ...
            <input
              ...
              placeholder="000000"
              className="text-center text-4xl font-mono tracking-[0.5em] w-72 bg-white border-2 border-zinc-200 rounded-lg px-4 py-4 text-zinc-900 focus:outline-none focus:border-darkDelegation focus:ring-4 focus:ring-darkDelegation/10 mb-8 shadow-inner"
            />
            <div className="flex gap-4">
              <button
                type="button"
                onClick={() => setOtpStep('FORM')}
                className="px-6 py-3 rounded-md text-zinc-500 hover:text-zinc-800 hover:bg-zinc-100 text-sm font-bold transition-colors"
                disabled={submitting}
              >
                Back
              </button>
              <button
                ...
                className="inline-flex items-center gap-2 px-8 py-3 bg-darkDelegation text-white rounded-md text-sm font-black uppercase tracking-wider hover:bg-black transition-all active:scale-95 disabled:opacity-50 cursor-pointer shadow-sm"
              >
