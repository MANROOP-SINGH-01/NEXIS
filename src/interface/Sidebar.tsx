...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-60 h-screen min-h-screen bg-white border-r border-slate-200 flex flex-col shrink-0 select-none z-30">
      {/* Brand Header */}
      <div className="h-14 px-3.5 flex items-center justify-between border-b border-slate-200 shrink-0">
        <div className="flex items-center gap-2">
          {/* Symbol of NEXIS */}
          <div className="w-7 h-7 rounded-lg bg-blue-900 border border-blue-950 flex items-center justify-center text-white select-none shrink-0">
            <svg
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] font-semibold text-blue-800 bg-blue-100 px-1.5 py-0.2 rounded border border-blue-200">PORTAL</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 py-4 px-3 flex flex-col gap-1 overflow-y-auto">
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <button
              ...
              className={`group flex items-center gap-3 w-full px-3 py-2.5 rounded-md text-left transition-all cursor-pointer relative ${
                isActive
            ...
            >
              ...
              {isActive && (
                <div className="absolute left-0 top-0 bottom-0 w-1 rounded-l-md bg-blue-800" />
              )}
        ...
        {isAdmin && (
          <div className="pt-3 mt-2 border-t border-slate-200 flex flex-col gap-1">
            ...
            <button
              ...
              className="flex items-center gap-3 w-full px-3 py-2 rounded-md text-left bg-blue-50/70 hover:bg-blue-100/70 text-blue-900 font-bold transition-all cursor-pointer text-xs group"
            ...
            <button
              ...
              className="flex items-center gap-3 w-full px-3 py-2 rounded-md text-left bg-orange-50/70 hover:bg-orange-100/70 text-orange-900 font-bold transition-all cursor-pointer text-xs group"
      ...
      <div className="p-3 border-t border-slate-200 bg-zinc-50/40 space-y-2">
        {/* Team indicator */}
        <div
          onClick={() => setViewMode('design')}
          className="flex items-center gap-2.5 p-2 rounded-md bg-white border border-zinc-200/60 shadow-xs hover:border-zinc-300 transition-colors cursor-pointer group"
