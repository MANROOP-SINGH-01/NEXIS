    ...
    <div className="min-h-screen w-screen bg-gradient-to-br from-zinc-100 via-zinc-50 to-zinc-100 flex flex-col font-sans text-zinc-900 overflow-y-auto">
      ...
      <header className="w-full bg-white border-b border-zinc-200 shadow-xs px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-md bg-zinc-900 text-white flex items-center justify-center font-black text-sm shadow-xs">
            <Building2 size={20} />
          </div>
          <div>
        ...
        <div className="flex items-center gap-3">
          <a
            href="/"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-zinc-200 text-xs font-bold text-zinc-600 hover:bg-zinc-100 transition-colors"
          >
            ← Return to App
          </a>
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto p-4 md:p-8 flex flex-col justify-center">
        {loading && (
          <div className="bg-white rounded-lg border border-zinc-200/80 shadow-md p-12 text-center flex flex-col items-center justify-center gap-3">
        ...
        {loadError && !loading && (
          <div className="bg-white rounded-lg border border-red-200 shadow-md p-8 md:p-10 text-center flex flex-col items-center">
            <div className="w-16 h-16 rounded-lg bg-red-50 text-red-600 flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-xs text-zinc-400 font-mono bg-zinc-50 py-2 px-4 rounded-md inline-block border border-zinc-200 mb-6">
              Token ID: {token.slice(0, 16)}...
            </div>
            <div>
              <a
                href="/"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-zinc-900 hover:bg-black text-white text-xs font-bold rounded-md transition-all shadow-xs"
              >
        ...
        {data && !loading && (
          <div className="bg-white rounded-lg border border-zinc-200/80 shadow-xl overflow-hidden animate-in fade-in duration-300">
            ...
            <div className="p-6 md:p-8 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-zinc-50 rounded-lg p-4 border border-zinc-200/80 space-y-2">
              ...
              {data.status !== 'PENDING' && (
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    {data.reasonCode && (
                      <div className="mt-2 text-xs bg-white/80 p-2.5 rounded-md border border-rose-200/60 font-medium">
              ...
              {data.status === 'PENDING' && (
                <form onSubmit={handleSubmit} className="space-y-5 pt-2 border-t border-zinc-100">
                  {submitSuccess && (
                    <div className="p-4 bg-emerald-50 text-emerald-800 text-xs rounded-lg border border-emerald-200 font-bold flex items-center gap-2">
                  ...
                  {submitError && (
                    <div className="p-4 bg-rose-50 text-rose-800 text-xs rounded-lg border border-rose-200 font-bold flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-zinc-50 border border-zinc-200 rounded-md px-3.5 py-2.5 text-xs text-zinc-800 font-medium focus:outline-none focus:ring-2 focus:ring-zinc-900"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <button
                        ...
                        className={`flex items-center justify-center gap-2.5 p-3.5 rounded-lg border text-xs font-black tracking-wide transition-all cursor-pointer ${
                          decision === 'CONFIRMED'
                  ...
                  {decision === 'DENIED' && (
                    <div className="bg-rose-50/70 border border-rose-100 rounded-lg p-4 space-y-3 animate-in fade-in duration-200">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-white border border-rose-200 rounded-md px-3 py-2 text-xs text-zinc-800 font-medium focus:outline-none focus:ring-2 focus:ring-rose-500 cursor-pointer"
                        >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full bg-white border border-rose-200 rounded-md px-3 py-2 text-xs text-zinc-800 font-medium focus:outline-none focus:ring-2 focus:ring-rose-500 resize-y"
                        />
                      </div>
                    </div>
                  )}
                  ...
                  <div className="flex justify-end pt-2">
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-900 hover:bg-black text-white rounded-md text-xs font-black uppercase tracking-wider transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-md cursor-pointer active:scale-95"
                    >
                      {submitting ? (
                        <>
