      ...
      >
        ...
        <div className="max-w-md mx-auto">
          ...
          {byokError && (() => {
            ...
            return (
              <div className="mb-6 p-3 bg-red-50 border border-red-100 rounded-lg flex items-start gap-2 animate-in fade-in slide-in-from-top-2">
          ...
          <div className="mb-10">
            ...
            <div className="relative group">
              <input
                ...
                className="w-full bg-zinc-50 border border-zinc-100 rounded-lg px-6 py-4 pr-14 text-sm text-darkDelegation font-mono placeholder:text-zinc-300 placeholder:font-sans focus:outline-none focus:border-zinc-200 transition-all shadow-sm group-hover:shadow-md"
              />
              <button
                type="button"
