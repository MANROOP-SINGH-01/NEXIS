...
import { GEMINI_MODELS, GEMINI_API_KEY } from '../config.js'
...
export async function callGeminiTextWithRetry({ apiKey = GEMINI_API_KEY, prompt, systemInstruction, attempts = 3 }) {
  let lastError = null
